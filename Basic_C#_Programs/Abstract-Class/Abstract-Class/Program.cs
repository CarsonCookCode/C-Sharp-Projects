...
namespace Abstract_Class
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Make list of all employees with first name joe with for loop
            ...
            // Make list of all employees with first name joe with Lambda expression
            ...
            // Make list of all employees with id number greater than 15
